Mkwaycoin 0.6.1 BETA

Copyright (c) 2011-2017 Mkwaycoin Developers
...
Setup
-----
After completing windows setup then run mkwaycoin-qt.
Alternatively you can run windows command line (cmd) in mkwaycoin program dir.
  cd daemon
  mkwaycoind
You would need to create a configuration file mkwaycoin.conf in the default
wallet directory. Grant access to mkwaycoind/mkwaycoin-qt in anti-virus and firewall
