 ...
 * mkcoin public-key-hash-addresses have version 55 (or 111 testnet).
...
public:
    enum
    {
        PUBKEY_ADDRESS = 50,  // mkcoin: addresses begin with 'M'
        SCRIPT_ADDRESS = 110, // mkcoin: addresses begin with 'm'
