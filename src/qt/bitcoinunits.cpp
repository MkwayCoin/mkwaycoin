...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("MKW");
    case mBTC: return QString("mMKW");
    case uBTC: return QString::fromUtf8("μMKW");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Mkwaycoins");
    case mBTC: return QString("Milli-Mkwaycoins (1 / 1,000)");
    case uBTC: return QString("Micro-Mkwaycoins (1 / 1,000,000)");
    default: return QString("???");
    }
}
