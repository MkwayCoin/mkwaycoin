 ...
 * The Mkwaycoin developers 2020-2021
 */
    ...
    prevBlocks(0)
{
    ...
    setWindowTitle(tr("Mkwaycoin") + " - " + tr("Wallet"));
...
#ifndef Q_OS_MAC
    QApplication::setWindowIcon(QIcon(":icons/mkwaycoin"));
    setWindowIcon(QIcon(":icons/mkwaycoin"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Mkwaycoin address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/mkwaycoin"), tr("&About Mkwaycoin"), this);
    aboutAction->setStatusTip(tr("Show information about Mkwaycoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for Mkwaycoin"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/mkwaycoin"), tr("&Show / Hide"), this);
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Mkwaycoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Mkwaycoin addresses"));

    openRPCConsoleAction = new QAction(QIcon(":/icons/debugwindow"), tr("&Debug window"), this);
    openRPCConsoleAction->setStatusTip(tr("Open debugging and diagnostic console"));

    openChatroomAction = new QAction(QIcon(":/icons/mkwaycoin"), tr("&Chatroom"), this);
    openChatroomAction->setStatusTip(tr("Open https://discord.gg/pyT5pt8 in a web browser."));

    openForumAction = new QAction(QIcon(":/icons/mkwaycoin"), tr("&Forum"), this);
    openForumAction->setStatusTip(tr("Open https://forum.mkwaycoin.space in a web browser."));
...
#ifndef Q_OS_MAC
            QApplication::setWindowIcon(QIcon(":icons/mkwaycoin_testnet"));
            setWindowIcon(QIcon(":icons/mkwaycoin_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/mkwaycoin_testnet"));
#endif
            if(trayIcon)
            {
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Mkwaycoin client"));
...
void BitcoinGUI::openChatroom() {
    QDesktopServices::openUrl(QUrl("https://discord.gg/pyT5pt8"));
}

void BitcoinGUI::openForum() {
    QDesktopServices::openUrl(QUrl("https://forum.mkwaycoin.space"));
}
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Mkwaycoin network", "", count));
}
...
{
    QString strTitle = tr("Mkwaycoin"); // default title
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            message(tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Mkwaycoin address or malformed URI parameters."),
